...
```sh
make deploy IMG=<some-registry>/etherealpod:tag
```
...
```sh
make build-installer IMG=<some-registry>/etherealpod:tag
```
...
```sh
kubectl apply -f https://raw.githubusercontent.com/<org>/etherealpod/<tag or branch>/dist/install.yaml
```
